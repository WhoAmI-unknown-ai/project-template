...
function getMockData(ep){const m={'/expiry':[{name:'Wheat',batchId:'B-1001',quantity:500,unit:'kg',expiryDate:getFutureDate(5)}],'/inventory':[{name:'Wheat',currentStock:75000,maxStock:100000,dailyConsumption:5000,unit:'kg'}],'/batches':[],'/suppliers':[]};return m[ep.split('?')[0]]||[];}
